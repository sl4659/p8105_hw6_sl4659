...
weather_df = 
  rnoaa::meteo_pull_monitors(
    ...
    date_max = "2017-12-31") %>%
  mutate(
    name = recode(id, USC00519397 = "Waikiki_HA"),
    tmin = tmin / 10,
    tmax = tmax / 10) %>%
...
```
    ...
    ## file path:          /Users/shenglin/Library/Caches/rnoaa/ghcnd/USC00519397.dly

    ## file last updated:  2019-11-15 20:27:08

    ## file min/max dates: 1965-01-01 / 2019-11-30
...
The distribution of log(beta0\_hat\*beta0\_hat) has a somewhat heavy
tail extending to low values and a bit of a “shoulder”, features that
...
The distribution of r.squared has a bell-shaped curve that suggests
normality.
