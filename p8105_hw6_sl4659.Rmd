...
The distribution of log(beta0_hat*beta0_hat) has a somewhat heavy tail extending to low values and a bit of a “shoulder”, features that may be related to the frequency with which large outliers are included in the bootstrap sample.
...
The distribution of r.squared has a bell-shaped curve that suggests normality.
